...
Those rights can be exercised in any media, supports and formats, whether now
...
the Work, of the exhaustion of those rights or of other applicable limitations
thereto.
...
a repository where this Source will be easily and freely available for as long as
...
fact of your having accepted any warranty or additional liability.
...
Simplatab bundles dependencies whose licences are reproduced in their
respective wheels distributed inside the Docker image:

- scikit-learn, numpy, scipy, pandas — BSD 3-Clause
- xgboost — Apache-2.0
- lightgbm — MIT
- shap — MIT
- featurewiz — Apache-2.0
- matplotlib — Matplotlib Licence (BSD-style)
- seaborn — BSD 3-Clause
- Flask, Werkzeug, Jinja2, MarkupSafe — BSD 3-Clause
- MiniSom — Creative Commons BY 3.0
- PyYAML — MIT

All bundled libraries are compatible with the EUPL-1.2 terms above.
